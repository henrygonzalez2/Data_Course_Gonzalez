...
#dim is short for dimension, it gives you the range and 
...
even <- iris[seq(2,150,2),]
#creates an object that contains the data of the even nmumbered rows in the iris dataset

# 2.  Create a new object called iris_chr which is a copy of iris, except where every column is a character class

all_columns <- as.character(iris$Sepal.Length, iris$Sepal.Width, iris$Petal.Length, iris$Petal.Width,iris$Species)
...
#subset command goes into the set and allows you to select rows with certain tratis.
